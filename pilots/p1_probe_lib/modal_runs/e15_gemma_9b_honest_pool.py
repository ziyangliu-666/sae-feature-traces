...
Reads: logs/e12_gemma_9b_pilot.json (probe library from E12-9B).
Writes:
  logs/sigma_calibration_gemma2_9b_L20.json
  logs/recipe1_gemma2_9b_honest_pool.json
...
E12_JSON = LOCAL_ROOT / "logs" / "e12_gemma_9b_pilot.json"
SIG_OUT = LOCAL_ROOT / "logs" / "sigma_calibration_gemma2_9b_L20.json"
POOL_OUT = LOCAL_ROOT / "logs" / "recipe1_gemma2_9b_honest_pool.json"
