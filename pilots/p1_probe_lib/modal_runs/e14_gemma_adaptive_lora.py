...
logs/e12_gemma_pilot.json so the threshold is comparable.
"""
import json
...
PILOT_JSON = LOCAL_ROOT / "logs" / "e12_gemma_pilot.json"
...
def main():
    ...
    out_path = LOCAL_ROOT / "logs" / "e14_gemma_adaptive_lora.json"
