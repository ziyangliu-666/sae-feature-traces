...
Consumes:
  results/recipe1_qwen3_honest_pool_multikernel.json  (per_probe_z: [96, 32] per config)
  results/e16_whitebox_jointz_qwen3_ksweep_strongest.json  (z_top32: [96, 32])
  results/sigma_calibration_qwen3_1.7b_L14.json  (mu, sd at top-32)
...
Writes results/ksweep_results.json.
"""
import json
import numpy as np
