...
app = modal.App("e10b-circuit-ablation-8cats")
GPU = "L4"
...
TOP_K = 32
CATS = ["ioi", "induction", "syntax", "factual", "coref",
        "arithmetic", "lang", "negation"]
N_PROBES_PER_CAT = 6
...
def main():
    ...
    r = run.remote(lib)
    out = LOCAL_ROOT / "results" / "e10b_circuit_ablation_8cats.json"
