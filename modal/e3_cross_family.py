...
Inputs (mounted from local):
  results/probe_library_qwen3_1.7b_L14_k96.json    (E1 output)
  results/sigma_calibration_qwen3_1.7b_L14.json    (E7 output)

Outputs (downloaded back):
  results/e3_cross_family_results.json
"""
import modal
import json
...
def main():
    ...
    out_path = LOCAL_ROOT / "results" / "e3_cross_family_results_v2.json"
