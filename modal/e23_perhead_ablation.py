...
Output: results/e23_perhead_ablation.json
"""
import json
import modal
...
SIG_LOCAL = LOCAL_ROOT / "results" / "sigma_calibration_qwen3_1.7b_L14.json"
...
def main():
    ...
    out = LOCAL_ROOT / "results" / "e23_perhead_ablation.json"
