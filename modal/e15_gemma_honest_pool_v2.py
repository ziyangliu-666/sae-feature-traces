...
results/e12_gemma_pilot.json:sigma_calibration). v2 does two phases in a
...
SIG_OUT = LOCAL_ROOT / "results" / "sigma_calibration_gemma2_2b_L12.json"
POOL_OUT = LOCAL_ROOT / "results" / "recipe1_gemma2_honest_pool_v2.json"
