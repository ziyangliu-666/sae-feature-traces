...
Output: results/recipe1_qwen3_honest_pool_multikernel.json
"""
import json
import modal
...
LIB_PATH = LOCAL_ROOT / "results" / "probe_library_qwen3_1.7b_L14_k96.json"
SIG_PATH = LOCAL_ROOT / "results" / "sigma_calibration_qwen3_1.7b_L14.json"
POOL_OUT = LOCAL_ROOT / "results" / "recipe1_qwen3_honest_pool_multikernel.json"
